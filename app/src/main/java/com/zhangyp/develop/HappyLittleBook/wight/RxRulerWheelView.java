...
public class RxRulerWheelView extends View implements GestureDetector.OnGestureListener {
    ...
    protected void init(AttributeSet attrs) {
        ...
        TypedArray ta = attrs == null ? null : getContext().obtainStyledAttributes(attrs, R.styleable.RxRulerWheelView);
        if (ta != null) {
            mHighlightColor = ta.getColor(R.styleable.RxRulerWheelView_lwvHighlightColor, mHighlightColor);
            mMarkTextColor = ta.getColor(R.styleable.RxRulerWheelView_lwvMarkTextColor, mMarkTextColor);
            mMarkColor = ta.getColor(R.styleable.RxRulerWheelView_lwvMarkColor, mMarkColor);
            mIntervalFactor = ta.getFloat(R.styleable.RxRulerWheelView_lwvIntervalFactor, mIntervalFactor);
            mMarkRatio = ta.getFloat(R.styleable.RxRulerWheelView_lwvMarkRatio, mMarkRatio);
            mAdditionCenterMark = ta.getString(R.styleable.RxRulerWheelView_lwvAdditionalCenterMark);
            mCenterTextSize = ta.getDimension(R.styleable.RxRulerWheelView_lwvCenterMarkTextSize, mCenterTextSize);
            mNormalTextSize = ta.getDimension(R.styleable.RxRulerWheelView_lwvMarkTextSize, mNormalTextSize);
            mCursorSize = ta.getDimension(R.styleable.RxRulerWheelView_lwvCursorSize, mCursorSize);
        }
